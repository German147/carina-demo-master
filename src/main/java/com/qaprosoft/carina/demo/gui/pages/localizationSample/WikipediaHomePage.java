...
public class WikipediaHomePage extends AbstractPage {
    ...
    /**
     * This method a mechanism in how we change the web page based in our config,it is oped wekipedia
     * and the with this method we choose the required location, at the end of the method we are clicking
     * the changing language button
     *
     * @param driver
     * @return
     */
