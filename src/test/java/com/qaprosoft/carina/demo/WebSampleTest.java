...
import com.qaprosoft.carina.demo.service.IPhoneModelService;
 ...
 * @author qpsdemo
 */
public class WebSampleTest implements IAbstractTest, IPhoneModelService {
    @Test()
    @MethodOwner(owner = "qpsdemo")
    @TestPriority(Priority.P3)
    @TestLabel(name = "feature", value = {"web", "regression"})
    public void testModelSpecs() {
        ModelInfoPage productInfoPage = getModelInfoPage(getDriver(),"Samsung","A05");
